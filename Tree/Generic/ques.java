...
public class ques {
        ...
        for (int i = 0; i < str.length(); i++) {
            if (str.charAt(i) == ',') {
                ...
                if (!st.isEmpty()) {
                    ...
                    // Integer.parseInt(String.valueOf(str.charAt(i - 1))); for 20 it'll take 0 this
                    // not valid we need to use data string builder
                    root = node;
                }
                st.push(node);
    ...
    public static void preorderTree(int[] pre, int k) {
        

    }

    // all left after this----------------  *************GENERIC PART LEFT
